...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header myColorBg text-white">{{ __('Register') }}</div>
                        ...
                        <form method="POST" action="/users/post">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btnYoussry myColorBg text-white">
                                        {{ __('Register') }}
                                    </button>
                                </div>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <label class="text-info active textWarning">
                            ...
                            Thank you for register in Houda Sharawy Language School.
                            <Br>
                            As soon as we will activate your account
                        </label>
                    </div>
                    <div class="modal-footer">
                        <a href="/" type="button" class="btn myColorBg btnYoussry text-white-50">Close
                        </a>
                    </div>
                </div>
            </div>

@extends('layouts.app')
@section('content')
    <div class="text-center"><img src="{{asset('images/junior.png')}}" class="img-fluid"></div>

    <div class="container text-center">
        <h2 class="textTitleY" >{{config('app.fullName' ,'Houda Sharawy Language School')}}<br>JUNIOR</h2>
